...
export default class ProgressEditPanel extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/ProgressEditPanel.ets(26:5)");
            Column.height({ "id": 16777229, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/ProgressEditPanel.ets(27:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Slider.debugLine("view/ProgressEditPanel.ets(28:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ProgressEditPanel.ets(40:9)");
            ...
            Text.fontColor({ "id": 16777281, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            Text.textAlign(TextAlign.Center);
            Text.margin({ left: { "id": 16777247, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/ProgressEditPanel.ets(50:7)");
            ...
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new CustomButton(this, {
                        buttonText: { "id": 16777265, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }
                    }, undefined, elmtId));
                }
                else {
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new CustomButton(this, {
                        buttonText: { "id": 16777267, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }
                    }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {});
...
class CustomButton extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        super(parent, __localStorage, elmtId);
        this.__buttonColor = new ObservedPropertyObjectPU({ "id": 16777287, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }, this, "buttonColor");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/ProgressEditPanel.ets(84:5)");
            ...
            Text.onTouch((event) => {
                if (event !== undefined && event.type === TouchType.Down) {
                    this.buttonColor = { "id": 16777280, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" };
                }
                if (event !== undefined && event.type === TouchType.Up) {
                    this.buttonColor = { "id": 16777287, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" };
                }
            });
            if (!isInitialRender) {
                Text.pop();
...
function __Text__dialogButtonStyle() {
    ...
    Text.height({ "id": 16777222, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
    Text.width({ "id": 16777223, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
