...
export default class TargetList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/TargetList.ets(31:5)");
            Column.width(CommonConstants.MAIN_BOARD_WIDTH);
            Column.height(CommonConstants.FULL_HEIGHT);
            Column.padding({ top: { "id": 16777241, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" } });
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("view/TargetList.ets(32:7)");
            Row.width(CommonConstants.FULL_WIDTH);
            Row.height({ "id": 16777231, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            Row.padding({
                left: { "id": 16777236, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" },
                right: { "id": 16777238, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }
            });
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777275, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            Text.debugLine("view/TargetList.ets(33:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("view/TargetList.ets(37:9)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        if (this.isEditMode) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Text.create({ "id": 16777265, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                                    Text.debugLine("view/TargetList.ets(40:13)");
                                    __Text__operateTextStyle({ "id": 16777285, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                                    Text.margin({ left: { "id": 16777240, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" } });
                                    Text.onClick(() => {
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Text.create({ "id": 16777274, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                                    Text.debugLine("view/TargetList.ets(48:13)");
                                    __Text__operateTextStyle({ "id": 16777285, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                                    Text.margin({
                                        left: { "id": 16777240, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }
                                    });
                                    if (!isInitialRender) {
                                        Text.pop();
                                    }
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Checkbox.create();
                                    Checkbox.debugLine("view/TargetList.ets(53:13)");
                                    Checkbox.select(this.isSelectAll());
                                    Checkbox.selectedColor({ "id": 16777285, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                                    Text.create({ "id": 16777269, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                                    Text.debugLine("view/TargetList.ets(62:13)");
                                    __Text__operateTextStyle({ "id": 16777285, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                                    Text.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("view/TargetList.ets(78:7)");
            List.edgeEffect(EdgeEffect.None);
            List.margin({ top: { "id": 16777235, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" } });
            ...
            const forEachItemGenFunction = (_item, index) => {
                const item = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("view/TargetList.ets(80:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("view/TargetList.ets(96:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isEditMode) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Button.createWithLabel({ "id": 16777268, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                        Button.debugLine("view/TargetList.ets(98:9)");
                        ...
                        __Button__operateButtonStyle({ "id": 16777286, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                        Button.onClick(() => {
                            this.deleteSelected();
                            this.selectAllOrCancel(false);
                            this.selectAll = false;
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Button.createWithLabel({ "id": 16777263, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                        Button.debugLine("view/TargetList.ets(108:9)");
                        __Button__operateButtonStyle({ "id": 16777285, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
                        Button.onClick(() => {
...
function __Text__operateTextStyle(color) {
    Text.fontSize({ "id": 16777253, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
    Text.fontColor(color);
    Text.lineHeight({ "id": 16777255, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
...
function __Button__operateButtonStyle(color) {
    Button.width({ "id": 16777220, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
    Button.height({ "id": 16777219, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
    ...
    Button.backgroundColor({ "id": 16777279, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
}
