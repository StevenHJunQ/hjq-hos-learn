...
class MainPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.dialogController = new CustomDialogController({
            ...
            offset: {
                ...
                dy: { "id": 16777226, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }
            },
            customStyle: true,
            autoCancel: false
        }, this);
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/MainPage.ets(57:5)");
            Column.width(CommonConstants.FULL_WIDTH);
            Column.height(CommonConstants.FULL_HEIGHT);
            Column.backgroundColor({ "id": 16777283, "type": 10001, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            if (!isInitialRender) {
                Column.pop();
            }
    ...
    titleBar(parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777278, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            Text.debugLine("pages/MainPage.ets(77:5)");
            Text.width(CommonConstants.TITLE_WIDTH);
            Text.height({ "id": 16777258, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            Text.fontSize({ "id": 16777257, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" });
            Text.fontWeight(CommonConstants.FONT_WEIGHT_LARGE);
            Text.textAlign(TextAlign.Start);
            Text.margin({
                top: { "id": 16777259, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" },
                bottom: { "id": 16777259, "type": 10002, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" }
            });
            if (!isInitialRender) {
                Text.pop();
            }
    ...
    saveTask(taskName) {
        if (taskName === '') {
            promptAction.showToast({
                message: { "id": 16777266, "type": 10003, params: [], "bundleName": "com.huawei.targetmanagement", "moduleName": "entry" },
