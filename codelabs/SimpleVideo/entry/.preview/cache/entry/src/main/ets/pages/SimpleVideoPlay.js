...
class Play extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.startIconResource = { "id": 16777246, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
        this.backIconResource = { "id": 16777249, "type": 20000, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/SimpleVideoPlay.ets(50:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/SimpleVideoPlay.ets(51:7)");
            Row.width(ALL_PERCENT);
            Row.margin({
                left: 12 /* FIRST_MARGIN */,
                top: 12 /* FIRST_MARGIN */
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/SimpleVideoPlay.ets(52:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777240, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" });
            Text.debugLine("pages/SimpleVideoPlay.ets(59:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Stack.create();
            Stack.debugLine("pages/SimpleVideoPlay.ets(72:7)");
            if (!isInitialRender) {
                Stack.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
            ...
            if (!this.isPlay && !this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/SimpleVideoPlay.ets(74:11)");
                        Image.width(50 /* FIFTH_MARGIN */);
                        Image.height(50 /* FIFTH_MARGIN */);
                        Image.zIndex(2 /* IMAGE_Z_INDEX */);
                        if (!isInitialRender) {
                            Image.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Progress.create({
                            value: 0 /* PROGRESS_VALUE */,
                            total: 100 /* PROGRESS_TOTAL */,
                            type: ProgressType.ScaleRing
                        });
                        Progress.debugLine("pages/SimpleVideoPlay.ets(80:11)");
                        Progress.color(Color.Grey);
                        Progress.value(this.progressVal);
                        Progress.width(80 /* PROGRESS_WIDTH */);
                        Progress.style({
                            strokeWidth: 15 /* PROGRESS_STROKE_WIDTH */,
                            scaleCount: 15 /* PROGRESS_SCALE_COUNT */,
                            scaleWidth: 5 /* PROGRESS_SCALE_WIDTH */
                        });
                        Progress.zIndex(1 /* PROGRESS_Z_INDEX */);
                        if (!isInitialRender) {
                            Progress.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
