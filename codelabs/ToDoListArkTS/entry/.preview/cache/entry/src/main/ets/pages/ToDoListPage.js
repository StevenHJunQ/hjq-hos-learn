...
class ToDoListPage extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777235, "type": 10003, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            ...
            Text.lineHeight({ "id": 16777226, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Text.width(CommonConstants.TITLE_WIDTH);
            Text.margin({
                top: { "id": 16777229, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" },
                bottom: { "id": 16777228, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" }
            });
