...
export default class ToDoItem extends ViewPU {
    ...
    labelIcon(icon, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.width({ "id": 16777223, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Image.height({ "id": 16777223, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Image.margin({ "id": 16777222, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.height({ "id": 16777225, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
            Row.onClick(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isComplete) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.labelIcon.bind(this)({ "id": 16777231, "type": 20000, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
                });
            }
            if (!isInitialRender) {
                If.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontSize({ "id": 16777224, "type": 10002, params: [], "bundleName": "com.huawei.todolist", "moduleName": "entry" });
